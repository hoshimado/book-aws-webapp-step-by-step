 ...
 * **リスト4.1**: サンプルアプリでのLambdaフォルダーの構成
...
この値を、開いたjsファイルの中のキー `publicBase64` の部分の値に、コピー＆ペーストしてください。  
（この値は、本文の節「§2.2 JWTへ署名する際に使うキーペアを作成」で生成した  
